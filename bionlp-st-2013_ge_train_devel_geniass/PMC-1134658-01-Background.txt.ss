Members of the transforming growth factor beta (TGF-beta) superfamily play central roles in controlling cellular proliferation, differentiation, migration and apoptosis [1].
These cytokines can be divided into three subgroups: TGF-beta, the activins/inhibins, and the bone morphogenetic proteins (BMPs), of which the latter constitute the largest family.
...
TGF-beta has been intensively studied in normal and malignant haematopoietic cells and is one of the most potent endogenous negative regulators known to date.
[4].
