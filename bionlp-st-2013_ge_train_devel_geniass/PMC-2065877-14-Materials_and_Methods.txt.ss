...
For BrdU detection, the FITC-BrdU flow kit was used as instructed by the manufacturer (BD Bioscience).
...
To expose BrdU epitopes, cells were treated with Dnase and stained with FITC-conjugated anti-BrdU antibody.
Flow cytometry was performed on FACScalibur using the CellQuest program (Becton Dickinson).
