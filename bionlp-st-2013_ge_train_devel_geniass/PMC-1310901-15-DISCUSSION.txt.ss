...
One of them (#54) is adjacent to an identified regulatory element (NFkappaB-site), indicating a possible involvement of this site.
At two further CpG sites (#48, 45) the methylation status in IRF-4-positive was lower than that of IRF-4-negative cells.
These CpG sites are located in an NFkappaB and an SP1 element (31) and thus may also play a role in regulation of IRF-4 expression.
...
Furthermore, methylation of the central CpG in the NFkappaB element inhibits binding of the NFkappaB protein complexes (38), promoting the significance of the observed methylation differences in IRF-4-positive and -negative cells.
