...
Previous studies by Bettelli and colleagues have demonstrated that Foxp3 can repress both the basal levels of NF-kappaB activation as well as tumor necrosis factor-alpha-stimulated NF-kappaB activation [15].
Our next step was to determine whether Foxp3 could also suppress the activation of NF-kappaB caused by a strong viral transactivator protein.
HTLV-I encodes a multifunctional transactivator protein, Tax, capable of activating both the NF-kappaB and CREB pathways [24-29].
...
As shown in Figure 4A, HTLV-I Tax strongly up-regulated NF-kappaB-dependent transcriptional activation (~60-fold).
...
This Gal4-BD-Tax fusion protein activated transcription of a synthetic promoter containing five Gal4 binding sites, while Gal4-BD was insufficient to stimulate transcription by itself (Figure 4D).
...
To confirm that Foxp3 had a direct effect on HTLV-I replication, we transfected HEK 293T cells with a well-characterized HTLV-I infectious molecular clone (termed ACH) [30] in the presence of full-length Foxp3, deltaFKH, or control vector.
ACH has been previously shown to direct the expression of viral antigens, produce infectious virus, and transform CD4+ T cells both in vitro and in vivo [31,32].
After 24 h, the amount of viral antigen expression, in this case Tax mRNA, was detected by a sensitive real-time RT-PCR assay.
