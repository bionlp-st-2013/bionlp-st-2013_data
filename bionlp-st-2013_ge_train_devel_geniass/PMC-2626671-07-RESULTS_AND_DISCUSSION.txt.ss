...
Collectively, these data provide evidence that Runx3, together with T-box factors, orchestrates a complex program of transcriptional regulation in differentiating CTL (Fig. 4 C).
Runx3 is present in naive CD8+ T cells before activation (12).
It represses Runx1 and has a positive role in the induction of Eomes, granzyme B, perforin, and IFN-gamma.
Runx3 binds to promoters and putative regulatory regions of the latter three genes, suggesting a direct effect on gene expression.
Additional experiments are needed to determine whether Eomes and Runx1 are also direct target genes of Runx3.
Surprisingly, Runx3 contributed to the optimal expression of TNF, IL-2, and IFN-gamma at day 4 (Fig. S2).
...
Runx3 continues to be required for IFN-gamma expression even at day 6, perhaps because of its role in the induction of Eomes expression (Fig. 4 A).
An unexpected finding was that the two T-box transcription factors, T-bet and Eomes, are up-regulated with very different kinetics in CD8+ T cells under our culture conditions and have nonredundant roles in the subsequent expression of key effector proteins (Fig. 4 C).
...
Surprisingly, however, Eomes and T-bet appeared nonredundant in their ability to induce two other markers of CTL function, Prf1 and Gzmb (Fig. 4 C).
...
Collectively, our data are consistent with a transcriptional network in which preexisting Runx3 cooperates with the induced T-box factors T-bet and Eomes and IL-2Rbeta signals (unpublished data) to orchestrate CTL differentiation (Fig. 4 C).
...
Whole-genome experiments in these and other systems will be required to establish whether cooperation between T-box and Runx family transcription factors is a general feature of cellular differentiation programs.