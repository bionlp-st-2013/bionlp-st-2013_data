...
Next, we wanted to test whether BMP-6 had different effect on naive and memory B cells.
Naive (CD19+CD27-) and memory (CD19+CD27+) B cells were isolated from peripheral blood by cell sorting of immunobead-isolated CD19+ B cells [15], and tested for their capacity to proliferate in the presence of BMP-6.
However, BMP-6 inhibited anti-IgM induced DNA synthesis in the two subpopulations to a similar extent, with a mean reduction of DNA-synthesis of 45% (n = 5; p <= 0,004) for naive B cells and 48% (n = 5; p <= 0,001) for memory B cells (Figure 1E).