...
As expected, the two specific complexes were also present in the case of the Sp1cons control probe (Figure 6A, lanes 2 and 3).
...
In contrast, no PCR signal was received with a primer pair recognizing a region in the A3G gene ~4000 bp downstream of the Sp1/Sp3-binding site (Figure 6C, lower panel).
