...
We found that pretreatment of cells with the SMAC peptide dramatically reduced the amount of cIAP1 associated with the CD40 signaling complex in cells stimulated with anti-CD40 antibody-coated beads (Fig. 5A).
...
In contrast, treatment with the SMAC peptide did not alter the amount or molecular weight of HOIP present in cell lysates.
...
To test the possibility that HOIP is responsible for the recruitment of other critical signaling proteins to CD40, we immunoprecipitated CD40 signaling complexes from HOIP-deficient and HOIP-reconstituted cells (Fig. 5B).
...
In contrast, IKKalpha/beta and IKKgamma were not detectable in CD40 immunoprecipitates recovered from HOIP-deficient cells (Fig. 5B,C).
...
As shown here and in our previous study [6], IKKgamma present in CD40 immunoprecipitates appears to have a higher molecular weight than that found in cell lysates.
...
Cell lysates and CD40 immunoprecipitates prepared from these cells were analyzed by Western blotting for the epitope tag (Fig. 5C).
This analysis produced a pattern of bands that was essentially the same as that obtained using an antibody specific for native IKKgamma (compare panels B and C in Fig. 5).
...
To determine what was responsible for the increased molecular weight of IKKgamma in CD40 immunoprecipitates, the protein samples were incubated with lambda phosphatase, which removes phosphates attached to tyrosine, threonine, or serine residues in proteins.
This treatment reduced much of CD40-associated IKKgamma to an apparent molecular weight similar to that of the protein in cell lysates (Fig. 5C).
However, at least one band of significantly higher molecular weight remained after phosphatase treatment, suggesting that CD40-associated IKKgamma is subject to at least one other modification in addition to phosphorylation.
