...
B cells from peripheral blood or cultured cell-lines were lysed in lysis buffer (glycerol 10%, beta-mercaptoethanol 5%, 0.0625 M Tris-HCL [pH 6.8], sodium dodecyl sulphate [SDS] 2.5%w/vol).
Total protein (30-100 mug) from each sample was run on 10% or 12% SDS/polyacrylamide (SDS/PAGE) gels and blotted onto nitrocellulose filters (Protran; Schleicher &Schuell GmbH, Dassel, Germany).
...
Quantification of Id1, Id2 and Id3 protein was calculated by normalizing the specific protein bands to beta-actin using Image Quant 5.5 software (Molecular Dynamics).