SHARPIN Is Essential for Cytokine Production, NF-kappaB Signaling, and Induction of Th1 Differentiation by Dendritic Cells
Spontaneous mutations of the Sharpin (SHANK-associated RH domain-interacting protein, other aliases: Rbckl1, Sipl1) gene in mice result in systemic inflammation that is characterized by chronic proliferative dermatitis and dysregulated secretion of T helper1 (Th1) and Th2 cytokines.
...
Mutant BMDC had defective activation of NF-kappaB signaling, whereas the MAPK1/3 (ERK1/2) and MAPK11/12/13/14 (p38 MAP kinase isoforms) and TBK1 signaling pathways were intact.
A mixed lymphocyte reaction showed that mutant BMDC only induced a weak Th1 immune response but stimulated increased Th2 cytokine production from allogeneic naive CD4+ T cells.
