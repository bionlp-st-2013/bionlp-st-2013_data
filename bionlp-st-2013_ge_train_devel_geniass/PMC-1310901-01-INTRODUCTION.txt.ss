...
Treatment with interferon alpha (IFN-alpha) prolongs survival of CML patients and is associated with a complete cytogenetic response in 5-33% of CML patients (1,2).
Recently, we described an impaired expression of the interferon regulatory factor 4 (IRF-4) in CML, correlating with poor response to IFN-alpha treatment (3).
