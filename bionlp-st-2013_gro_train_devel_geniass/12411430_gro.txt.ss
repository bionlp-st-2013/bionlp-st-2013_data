...
We found that two regulatory factor for X box (RFX) binding sites in exon1 of both the mouse and human genes are important for effective transcriptional repression observed only in non-neuronal cells by reporter assays.
...
These results suggest that RFX1 and 3 are pivotal factors in down-regulation of the MAP1A 5' promoter in non-neuronal cells.
