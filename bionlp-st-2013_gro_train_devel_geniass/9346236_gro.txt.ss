...
Mutations in the DNA binding domain of AMV-Myb render it independent of signaling events and concomitantly abrogate the collaboration between Myb and CCAAT Enhancer Binding Proteins (C/EBP), which are involved in granulocyte differentiation.
...
Our results suggest that Myb or factors it interacts with contribute to hematopoietic lineage choice and differentiation in a signal transduction-dependent fashion.
