...
We constructed full-length cDNA libraries using the oligo-capping method and prepared an arrayed cDNA pool consisting of 150 000 cDNAs randomly isolated from the libraries.
