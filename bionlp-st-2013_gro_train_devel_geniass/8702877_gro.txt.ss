...
The cDNA is collinear with respect to the coding region of the intronless genomic clone.
The conceptual translation product predicts a protein of 465 amino acids with a hyperacidic amino-terminal end, a DNA binding forkhead domain and a carboxyl-terminal part that is rich in homopolymeric runs of prolines and alanines.
The transcription start is identified using an RNase protection assay.
A 2.7-kilobase pair genomic DNA fragment, located immediately upstream of the translation start, was fused to a luciferase reporter gene.
...
A 5'-promoter deletion series delimits a DNA fragment necessary for WT-1 inducibility in cotransfection experiments.
