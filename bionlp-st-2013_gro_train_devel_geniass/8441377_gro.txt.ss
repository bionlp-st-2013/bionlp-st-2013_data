...
Using Scatchard analysis, we have determined the dissociation constants of homodimeric p49 and heterodimeric p49/p65 for binding to the HIV kappa B site.
p49 has a approximately 18-fold-lower affinity for the HIV kappa B site (KD = 69.1 pM) than does the approximately 50-kDa protein NFKB1(p50) derived from p105 (KD = 3.9 pM).
In contrast, the affinity of heterodimeric NFKB2(p49)/RelA(p65) for this site is approximately 6-fold higher (KD = 11.8 pM) than that of p49 alone.
...
Recombinant I kappa B-alpha(MAD-3) inhibited the DNA binding activity of p65, p49/p65, and p50/p65 but stimulated the binding of NFKB2(p49) or NFKB1(p50).
