...
This protein shows strong amino acid sequence similarity to the previously described Rev-ErbA alpha.
...
Amino acid sequence comparisons suggest that the A box sequence, which has been suggested to mediate monomer binding by other superfamily members, lies closer to the DNA-binding domain in BD73 and Rev-Erb than in other receptors.
