...
To study the role of LSIRF in human lymphocyte development, we have cloned the complete 5.3-kb cDNA for the human homolog (hLSIRF). hLSIRF is a protein of 450 amino acids with a predicted molecular weight of 51.6 kDa and possesses 92% identity at the amino acid level to mLSIRF, including near identity in the DNA-binding domain.
...
Sequence from a genomic clone for hLSIRF was compared to that from mouse and revealed an identical exon-intron structure and a conserved PU-1-binding motif in the promoter.
By FISH analysis, hLSIRF was mapped to 6p23-p25.
