...
ISGF3 has two components, termed ISGF3 alpha and ISGF3 gamma.
...
ISGF3 gamma DNA-binding activity was identified as a 48-kDa polypeptide, and partial amino acid sequence has allowed isolation of cDNA clones.
...
Sequencing of ISGF3 gamma cDNA clones revealed significant similarity to the interferon regulatory factor (IRF) family of DNA binding proteins in the amino-terminal 117 residues of ISGF3 gamma.
The other IRF family proteins bind DNA with a specificity related to but distinct from that of ISGF3 gamma.
We note sequence similarities between the related regions of IRF family proteins and the imperfect tryptophan repeats which constitute the DNA-binding domain of the c-myb oncoprotein.
