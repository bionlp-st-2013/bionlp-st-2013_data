...
Slight variations are caused by drug treatment in tumor-bearing mice as compared with untreated tumor-bearing controls; the pattern of effects of the selective antimetastatic agents does not differ from that of the reference cytotoxic compound used, cyclophosphamide.
These data thus indicate that the effects on hemostasis of the drugs examined can contribute only marginally to their antimetastatic action, since more pronounced effects on hemostasis have been shown to be required to significantly affect metastasis formation.
