...
Recently VEGF-B and VEGF-C, two new VEGF family members, have been identified that bind to the tyrosine kinase receptors flt-1 (VEGFR1), KDR (VEGFR2), and flt-4 (VEGFR3).
...
We have, therefore, measured the mRNA level of VEGF-B and VEGF-C together with their receptors by RNase protection assay (RPA) in 26 normal kidney samples and 45 renal cell cancers.
We observed a significant up-regulation of VEGF-B (P = 0.002) but not VEGF-C (P = 0.3) in neoplastic kidney compared with normal tissues.
In addition, although VEGF receptors were higher in tumors than normal kidney, there was a significant up-regulation of only flt-1 (P = 0.003) but not KDR (P = 0.12) or flt-4 (P = 0.09).
There was also a significant correlation between VEGF-C and both of its receptors flt-4 (P = 0.006) and KDR (P = 0.03) but no association between VEGF-B and its receptor flt-1 (P = 0.23).
...
In wild-type VHL cells, whereas VEGF-A was significantly up-regulated under hypoxic compared with normoxic conditions (P  less than  0.001), expression of VEGF-C was reduced (P  less than  0.002).
