...
It is believed that the role of the E1B-55kDa protein in transformation is to protect against p53-dependent apoptosis by binding to and inactivating p53.
It has been shown previously that the 55-kDa polypeptide abrogates p53-mediated transactivation and that mutants defective in p53 binding are unable to cooperate with E1A in transformation.
...
We now report that a nearby residue, Thr-495, also appears to be phosphorylated.
...
The E1B-55kDa product has been shown to exhibit intrinsic transcriptional repression activity when localized to promoters, such as by fusion with the GAL4 DNA-binding domain, even in the absence of p53.
