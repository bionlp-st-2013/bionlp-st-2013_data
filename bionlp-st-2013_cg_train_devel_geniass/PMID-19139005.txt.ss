...
Blockade of angiogenesis is an important approach for cancer treatment and prevention.
...
However, most current anti-VEGF agents often cause some side effects when given chronically.
...
Grape seed extract (GSE), a widely used dietary supplement, is known to have antitumor activity.
In this study, we have explored the activity of GSE on VEGF receptor and angiogenesis.
We found that GSE could directly inhibit the kinase activity of purified VEGF receptor 2, a novel activity of GSE that has not been characterized.
GSE could also inhibit the VEGF receptor/mitogen-activated protein kinase-mediated signaling pathway in endothelial cells.
...
Depletion of polyphenol with polyvinylpyrrolidone abolished the antiangiogenic activity of GSE, suggesting a water-soluble fraction of polyphenol in GSE is responsible for the antiangiogenic activity.
