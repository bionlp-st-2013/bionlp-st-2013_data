...
There was a significant positive relationship between PAI-1 levels and N-stage (p = < 0.05), presence of nodal metastases (p = < 0.05), stage grouping (p = < 0.01) and extent of disease (p = < 0.05) in the total group and the SCC subgroup, but not adenocarcinoma.
