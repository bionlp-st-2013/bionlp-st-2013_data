...
PURPOSE: Tumor fibroblasts (TF) have been suggested to play an essential role in the complex process of tumor-stroma interactions and tumorigenesis.
...
RESULTS: About 43% (126 of 292) of known deregulated genes in TFs were associated with cell proliferation, extracellular matrix remodeling, and immune response.
...
Moreover, the conditioned medium from TFs was found to be able to promote ESCC tumor cell growth, migration, and invasion in vitro.
