...
Tumor cells express the glycolytic regulator pyruvate kinase subtype M2 (M2-PK), which can occur in a tetrameric form with high affinity to its substrate phosphoenolpyruvate (PEP) and a dimeric form with a low PEP affinity.
...
Furthermore, the expression of M2-PK-binding peptide aptamers moderately reduced the growth of immortalized NIH3T3 cell populations by decelerating cell proliferation, but without affecting apoptotic cell death.
