...
PTHrP is also associated with the progression of skeletal metastases, and its dysregulated expression in advanced cancers causes malignancy-associated hypercalcemia.
Although PTHrP is frequently expressed by breast tumors and other solid cancers, its effects on tumor progression are unclear.
...
Pthrp ablation in the mammary epithelium of the PyMT-MMTV breast cancer mouse model caused a delay in primary tumor initiation, inhibited tumor progression, and reduced metastasis to distal sites.
...
Importantly, PTHrP-specific neutralizing antibodies slowed the progression and metastasis of human breast cancer xenografts.
