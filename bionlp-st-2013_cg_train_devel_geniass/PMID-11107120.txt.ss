...
The p75 receptor belongs to the tumor necrosis factor (TNF) family of death receptors and has been suggested as a receptor that mediates apoptosis in neuronal and NB cells.
PROCEDURE: To investigate the effect of p75 expression in NB, we transfected the p75 cDNA into SH-SY5Y cells, an NB cell line lacking expression of both p75 and TrkA.
RESULTS: Cell clones expressing elevated levels of p75 showed a high degree of apoptosis even in 10% serum-supplemented medium.
...
CONCLUSIONS: Thus, expression of the TrkA receptor itself inhibits p75 mediated apoptosis in NB cells.
