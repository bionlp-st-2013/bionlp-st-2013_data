...
METHODS: Patients diagnosed with chronic CSC, with clinical evidence of activity and treated with Photodynamic Therapy, are included in this report.
All were assessed by a complete ophthalmological examination, including assessment of the best corrected visual acuity (BCVA) using an ETDRS chart, fluorescein and indocyanine angiography and optical coherence tomography (OCT).
...
35% of eyes improved their BCVA by 2 lines or more, 45% remained stable and 18% lost 2 lines or more.
...
An increase of atrophy over the Retinal Pigment Epithelium (RPE) was observed in another patient.
...
However, the increase in visual acuity is variable, probably due to the extent of RPE damage.
