...
This usually involves screening of potential anti-angiogenic compounds on endothelial cells.
...
Onconase similarly inhibited proliferation in all three cell lines (IC(50) = 0.3-1.0 microM) while (-4)rhEDN was more effective on immortalized HUVEC cell lines (IC(50) = 0.02-0.06 microM) than on primary HUVECs (IC(50) > 0.1 microM).
