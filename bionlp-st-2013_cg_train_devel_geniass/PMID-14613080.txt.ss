...
Vascular endothelial growth factor (VEGF) is a mitogen that acts exclusively on endothelial cells.
...
PATIENTS AND METHODS: The paraffin sections from 49 subjects with OSCC were subjected to immunohistochemical studies to measure the highest MVD (h-MVD) and cytoplasmic immunoreactivity of VEGF.
The findings in the tissue samples were analyzed with regard to the patients' risk factors and clinical course.
RESULTS: The OSCC samples had an average h-MVD score of 27.7/mm(2).
...
A marginally significant association was also noted between the h-MVD and patient survival (P =.056).
...
CONCLUSION: The data suggest that both h-MVD and VEGF immunoreactivity may be useful predictors for the progression of a subset of OSCC associated mostly with betel use.
Antiangiogenesis therapy might have a role in reducing regional metastasis.
