...
Under specific conditions, casein could be used as an exogenous substrate as well.
...
Although contaminating kinases were detectable in the immune complexes, at least the p53 molecules were phosphorylated in vitro in a more specific way.
...
Finally, anti-p53 monoclonal antibodies only slightly affected in vitro phosphorylation reactions, whereas a p53 molecule from a simian virus 40-free, chemically transformed human cell line was not phosphorylated in vitro under any condition tested.
Thus, it is highly unlikely that the p53 molecule per se carries intrinsic or even associated kinase activities.
