...
BACKGROUND: We suggest that surgical extirpation of primary breast cancer among other effects accelerates relapse for some premenopausal node-positive patients.
...
This has been suggested as one of the mechanisms to explain the mammography paradox for women aged 40-49 years.
...
HYPOTHESIS: We speculate that there is a burst of angiogenesis of distant dormant micrometastases after surgery in approximately 20% of premenopausal node-positive patients.
...
TESTING THE HYPOTHESIS: Stimulation of dormant micrometastases by primary tumor removal is known to occur in animal models.
However, we need to determine whether it happens in breast cancer.
