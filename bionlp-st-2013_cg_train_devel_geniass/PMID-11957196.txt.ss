...
In murine models, the latter produces a hyperproliferative response to G-CSF, confers resistance to apoptosis, and enhances cell survival.
...
Alternatively, and equally plausible, G-CSF may simply be an "innocent bystander" that corrects neutropenia, prolongs patient survival, and allows time for the malignant predisposition to declare itself.
In patients who transform to overt MDS or AML, hematopoietic stem cell transplantation is the only chance for cure.
In those with "soft" signs of MDS, such as an isolated clonal cytogenetic change but without other evidence of MDS, or with an isolated G-CSF receptor mutation, there is room for conservative management.
