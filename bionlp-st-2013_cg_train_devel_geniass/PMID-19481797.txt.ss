...
Promoting angiogenesis via delivery of vascular endothelial growth factor (VEGF) and other angiogenic factors is both a potential therapy for cardiovascular diseases and a critical aspect for tissue regeneration.
...
Treatment of cultured human endothelial cells with DAPT, a gamma secretase inhibitor, increased cell migration and sprout formation in response to VEGF stimulation with a biphasic dependence on DAPT concentration.
Further, delivery of an appropriate combination of DAPT and VEGF from an injectable alginate hydrogel system into ischemic hindlimbs led to a faster recovery of blood flow than VEGF or DAPT alone; perfusion levels reached 80% of the normal level by week 4 with combined DAPT and VEGF delivery.
