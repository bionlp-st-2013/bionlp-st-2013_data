...
Here we analyzed LDH5 protein expression in a well characterized large cohort of primary lung cancers in correlation to clinico-pathological data and its possible impact on patient survival.
METHODS: Primary lung cancers (n = 269) and non neoplastic lung tissue (n = 35) were tested for LDH5 expression by immunohistochemistry using a polyclonal LDH5 antibody (ab53010).
The results of LDH5 expression were correlated to clinico-pathological data as well as to patient's survival.
In addition, the results of the previously tested transketolase like 1 protein (TKTL1) expression were correlated to LDH5 expression.
