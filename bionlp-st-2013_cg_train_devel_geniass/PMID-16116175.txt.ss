...
During embryogenesis, vascular and hemopoietic cells originate from a common precursor, the hemangioblast.
...
Furthermore, we demonstrate that increased vascular endothelial growth factor (VEGF)-A secretion by tumor cells, as well as activation of VEGF receptor-2 in bone marrow cells does not alter the mobilization and incorporation of marrow-derived endothelial progenitors into tumor vasculature.
...
By ruling out cell fusion, we clearly demonstrate the existence of an adult hemangioblast, but the differentiation of marrow stem cells toward the endothelial lineage is an extremely rare event.
