...
Transformation of primary cells in cultures requires both overcoming growth arrest by stimulating the cell cycle and blocking cell death activities presumably activated by oncogene-mediated hyperproliferation signals.
...
Thus, neither the p53-binding region nor the Bcl-2 homology region of T antigen was sufficient to prevent cell death induced by the DNA-damaging agent.
T-antigen-mediated sensitization occurred independently of retinoblastoma protein or p53 and p300 binding.
An N-terminal segment containing the first 127 T-antigen amino acids (T1-127) was sufficient to sensitize cells.
...
The introduction of mutations into the T-antigen J domain resulted in mutation-specific and variable inhibition of apoptosis.
