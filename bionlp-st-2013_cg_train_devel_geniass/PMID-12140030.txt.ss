...
PURPOSE: To optimize the method of treating choroidal neovascularization (CNV) associated with age-related macular degeneration (AMD).
...
The system also permits precise aiming and delivery of 810- nm wavelength photocoagulation laser energy to target FVs on a real-time ICG angiogram image of the choroidal vasculature.
...
After acquiring and interpreting diagnostic angiograms and repositioning a patient in front of the device, feeder vessel DEP and treatment evaluation required 15 to 20 minutes.
...
The combination diagnosis/treatment device should be useful in optimizing FV treatment and in refining and evaluating the efficacy of DEP in future clinical trials.
