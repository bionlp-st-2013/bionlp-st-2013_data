...
Long-term peritoneal dialysis (PD) is associated with alterations in peritoneal permeability and loss of ultrafiltration.
...
In uremic patients, NOS activity is positively correlated with the duration of PD.
Increased NOS activity is mediated solely by Ca(2+)-dependent NOS and, as shown by immunoblotting, an upregulation of endothelial NOS.
...
These data provide a morphologic (angiogenesis and increased endothelial area) and molecular (enhanced NOS activity and endothelial NOS upregulation) basis for explaining the permeability changes observed in long-term PD.
