...
Here clinical outcome is updated and its correlation with new immunological data is shown.
In 32 evaluated breast cancer patients with endocrine-dependent distant metastases treated with a new immunotherapy schedule (cyclic administration of beta-interferon and interleukin-2), cellular immunity, cytokines and CRP were related to the clinical course.
...
Interleukin-2 administration was followed by a significant increase in total lymphocytes, CD4+, CD8+, CD16+56+ (NK) cells, IL-6, IL-12, and CRP (from P<0.04 to P<0.000) but no change in IL-10 and TGFbeta1 during clinical benefit.
