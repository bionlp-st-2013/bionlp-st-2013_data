...
TES2 mediates the interaction with tumor necrosis factor receptor-associated death domain protein (TRADD) and plays a key role in transactivating NF-kappa B and AP-1.
...
However, it is not sufficient for the immortalization of MEF, and MEF-LMP1(TRADD) cells eventually enter growth arrest.
