...
Airway angiogenesis and microvascular remodeling are known features of bronchial asthma, but the mechanisms of these structural alterations are just beginning to be elucidated.
Vascular endothelial growth factor (VEGF), one of the most potent angiogenic factors, stimulates endothelial cell proliferation and induces the angiogenesis.
Recently, considerable attentions have been devoted to the physiological roles of angiopoietin (Ang)-1 and -2 as regulatory factors of VEGF.
...
Recently, there is an increasing number of patents which have been focused on the inhibitors of VEGF action.
