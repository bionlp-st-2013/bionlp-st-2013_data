...
PATIENTS AND METHODS: c-erbB2, evaluated by immunohistochemistry in 145 of 173 patients randomly assigned to 2-year adjuvant tamoxifen or no further therapy, was considered overexpressed if greater than 10% of the cells showed specific membrane staining.
The role of each prognostic variable and their independent effect were studied using the Cox model.
Disease-free (DFS) and overall (OAS) survival curves were estimated by the Kaplan-Meier method.
RESULTS: As of November 30, 1994, the median follow-up period was 12 years.
...
The same result was obtained when the model contained ER status and ER-tamoxifen interaction.
