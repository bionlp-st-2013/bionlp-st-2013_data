...
The authors evaluated the association between MDM2 expression and local failure, distant metastasis (DM), cause-specific mortality, and overall mortality in men treated in Radiation Therapy Oncology Group 8610 with radiotherapy, with or without androgen deprivation.
...
Cox proportional hazards multivariate analysis (MVA) was used to determine the relation of MDM2 to the endpoints.
MDM2 overexpression was manually classified as > 5% nuclear staining.
An image analysis system was also used to quantify the proportion of tumor nuclei with MDM2 staining (ACIS index) and staining intensity.
RESULTS: Overexpression of MDM2 by manual counts was seen in 44% (n = 47) of the patients.
In the manual count analysis, there was no significant relation between MDM2 overexpression and outcome.
