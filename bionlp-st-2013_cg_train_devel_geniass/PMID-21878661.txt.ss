...
Sunitinib is an oral multitargeted receptor tyrosine kinase inhibitor with antiangiogenic and antitumor activity that mainly targets vascular endothelial growth factor receptors (VEGFRs).
Very recently, sunitinib has been shown to be an active agent for the treatment of malignant pheochromocytomas.
However, it is unclear whether sunitinib acts only through an antiangiogenic mechanism or whether it may also directly target tumor cells.
...
Consistent with these apoptotic effects, our results showed that sunitinib inhibited phosphorylation of Akt and mTOR and was followed by a reduction of S6K1, which is a well-known target of mTOR.
