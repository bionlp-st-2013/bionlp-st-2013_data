...
BACKGROUND: Mesenchymal stem cells (MSCs) transplantation is of therapeutic potential after ischemic injury in both experimental and clinical studies.
Clinically, elderly patients are more vulnerable to acute myocardial infarction (AMI).
But little is known about the characteristics of young donor-derived MSCs transplanted to old patients with AMI.
The present study was designed to investigate the effect of transplanted MSCs from rats of different ages on the improvement of heart function after AMI.
METHODS: MSCs from Sprague-Dawley (SD) rats were isolated and cultured in vitro.
The apoptosis characteristics of MSCs were observed under conditions of ischemia and anoxia.
SD rats underwent MI received intramyocardial injection of MSCs from young donor rats (n = 8), old donor rats (n = 8), respectively.
...
RESULTS: The apoptosis rate of the old donor-derived MSCs group was significantly higher than that of the young donor-derived MSCs group under conditions of ischemia and anoxia (P  less than  0.05).
Engrafted MSCs survived, proliferated and differentiated into myocardium-like cells.
...
The transplantation of old donor-derived MSCs attenuated apoptosis of cardiomyocytes in the peri-infarct region compared with the control group and the effect was elevated in young donor-derived MSCs (P  less than  0.05).
