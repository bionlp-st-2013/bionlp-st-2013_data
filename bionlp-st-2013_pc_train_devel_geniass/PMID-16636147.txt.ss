...
However, in cells expressing tuberin, it is not known how repression of mTOR signaling is relieved to activate this pathway in response to growth factors and how hamartin participates in this process.
We show that hamartin colocalizes with hypophosphorylated tuberin at the membrane, where tuberin exerts its GTPase-activating protein (GAP) activity to repress Rheb signaling.
In response to growth signals, tuberin is phosphorylated by AKT and translocates to the cytosol, relieving Rheb repression.
Phosphorylation of tuberin at serines 939 and 981 does not alter its intrinsic GAP activity toward Rheb but partitions tuberin to the cytosol, where it is bound by 14-3-3 proteins.
