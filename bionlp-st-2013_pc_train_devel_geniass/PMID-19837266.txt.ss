...
Genomic and immunologic surveillance mechanisms are crucial in protection from cancer.
The tumor suppressor protein p53, encoded by TP53, is a major regulator of genome surveillance.
...
TP53 R72P showed a risk association with gene dosage effect (P=0.002) resulting in a strong association of homozygous genotype (OR=2.9, 95% CI=1.5-5.6) and no sex effect.
...
The HLA complex genes did not show any statistically significant interaction with R72P.
