...
Whether components of the pathway mediated by the SAP kinase p38 change their cellular location on activation is not clear; we have therefore studied the cellular localisation of components of this pathway before and after stimulation.
RESULTS: The p38 SAP kinase substrate MAP-kinase-activated protein kinase-2 (MAPKAP kinase-2) contains a putative nuclear localisation signal which we show is functional and required for activation by a variety of stimuli.
...
CONCLUSIONS: In the p38 SAP kinase pathway, MAPKAP kinase-2 serves both as an effector of p38 by phosphorylating substrates and as a determinant of cellular localisation of p38.
