...
Expression analysis of PML was carried out by immunohistochemical staining and correlated with disease-free survival (DFS) and overall survival (OS).
...
DFS in patients without PML expression was 28.0 months versus 45.1 and 75.5 for patients with focal and diffuse expression, respectively.
OS in the group of patients without PML expression, with focal expression, and with diffuse expression was 40, 48, and 77 months, respectively (P=0.002).
By a multivariate analysis, PML expression was the strongest prognostic factor for DFS (P=0.003) and the only statically significant prognostic factor for OS (P=0.009).
